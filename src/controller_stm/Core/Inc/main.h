...
#define Left_Toggle_UD_Pin GPIO_PIN_0
#define Left_Toggle_UD_GPIO_Port GPIOC
#define Left_Toggle_LR_Pin GPIO_PIN_1
#define Left_Toggle_LR_GPIO_Port GPIOC
#define Right_Toggle_UD_Pin GPIO_PIN_2
#define Right_Toggle_UD_GPIO_Port GPIOC
#define Right_Toggle_LR_Pin GPIO_PIN_3
#define Right_Toggle_LR_GPIO_Port GPIOC
